...
class LRParserGenerator:    
    def __init__(self, input_source=None):
        ...
        self.__rules = {}
        self.productions = []
        self.__parse_grammar(input_source)
    ...
    def __parse_grammar(self, input_source):
    ...
    def save_grammar(self, grammar_path):
        with open(grammar_path, 'wb') as f:
            pickle.dump((self.productions, self.syn), f)
...
if __name__ == "__main__":
    ...
    lr.build_tables()
    lr.save_tables("./analizator/action_table.pkl", "./analizator/goto_table.pkl")
    lr.save_grammar("./analizator/grammar.pkl")